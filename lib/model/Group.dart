...
class GroupInfo {
  ...
  GroupInfo.fromJson(Map<String, dynamic> json) {
    ...
    offer =
        json['offer'] != null ? new OfferAnswer.fromJson(json['offer']) : null;
    answer = json['answer'] != null
        ? new OfferAnswer.fromJson(json['answer'])
        : null;
  ...
  bool operator ==(covariant GroupInfo other) {
    ...
    return other.recentMessageSender == recentMessageSender &&
  ...
  String toStringS() {
    return '{'
        ...
        'isReadAr'
        ': '
        '${isReadAr!.map((x) => x.toMap()).toList()}'
        ','
        'members'
        ': '
        '${members!.map((x) => x.toMap()).toList()}'
        ','
        'admin'
        ': '
        '${admin?.toMap()}'
        ...
        ': '
        '${this.type!.name}'
        ',''callStatus'': ''$callStatus'',''status'': ''$status'',}';
  }

  factory GroupInfo.fromMap(Map<String, dynamic> map) {
    return GroupInfo(
      recentMessageSender: map['recentMessageSender'] != null
          ? map['recentMessageSender'] as String
          : null,
      inviteId: map['inviteId'] != null ? map['inviteId'] as String : null,
      isReadAr: map['isReadAr'] != null
          ? List<Read>.from(
              (map['isReadAr'] as List<int>).map<Read?>(
                (x) => Read.fromMap(x as Map<String, dynamic>),
              ),
            )
          : null,
      members: map['members'] != null
          ? List<Members>.from(
              (map['members'] as List<int>).map<Members?>(
                (x) => Members.fromMap(x as Map<String, dynamic>),
              ),
            )
          : null,
      ...
      offer: map['offer'] != null
          ? OfferAnswer.fromMap(map['offer'] as Map<String, dynamic>)
          : null,
      answer: map['answer'] != null
          ? OfferAnswer.fromMap(map['answer'] as Map<String, dynamic>)
          : null,
      groupPic: map['groupPic'] != null ? map['groupPic'] as String : null,
      recentMessage:
          map['recentMessage'] != null ? map['recentMessage'] as String : null,
      groupName: map['groupName'] != null ? map['groupName'] as String : null,
      time: map['time'] != null ? map['time'] as String : null,
      checked: map['checked'] != null ? map['checked'] as bool : null,
      checkIsRead:
          map['checkIsRead'] != null ? map['checkIsRead'] as bool : null,
      type: map['type'] != null
          ? Type.values.elementAt(findenum(map['type']))
          : null,
      callStatus:
...
class Admin {
  ...
  bool operator ==(covariant Admin other) {
    ...
    return other.adminId == adminId && other.adminName == adminName;
  }
...
class OfferAnswer {
  ...
  bool operator ==(covariant OfferAnswer other) {
    ...
    return other.sdp == sdp && other.type == type;
  }
  ...
  factory OfferAnswer.fromMap(Map<String, dynamic> map) {
    return OfferAnswer(
      ...
      cameraStatus:
          map['cameraStatus'] != null ? map['cameraStatus'] as bool : null,
    );
  }
}
